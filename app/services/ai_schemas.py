...
# Response Formats for API use
response_format_candidate = {
    "name": "interview_cheatsheet",
    "description": "Generates a cheatsheet for a job role candidate",
    "strict": True,
    "schema": candidate_schema
}

response_format_interviewer = {
    "name": "interview_screening",
    "description": "Generates a screening report for an interviewer",
    "strict": True,
...
response_format_jd_summary = {
    "name": "jd_summary",
    "description": "Generates a summary of a job description",
    "strict": True,
